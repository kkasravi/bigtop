...
# Kafka
KAFKA_NAME=kafka
KAFKA_RELNOTES_NAME=Kafka
KAFKA_PKG_NAME=kafka
KAFKA_BASE_VERSION=0.8.0-beta1
KAFKA_PKG_VERSION=0.8.0_beta1
KAFKA_RELEASE_VERSION=1
KAFKA_TARBALL_DST=$(KAFKA_NAME)-$(KAFKA_BASE_VERSION).tgz
KAFKA_TARBALL_SRC=$(KAFKA_NAME)-$(KAFKA_BASE_VERSION)-src.tgz
KAFKA_SITE=https://dist.apache.org/repos/dist/release/kafka
KAFKA_ARCHIVE=$(KAFKA_SITE)
